    ...
    public static final ItemGroup MORE_FOOD_GROUP = Registry.register(Registries.ITEM_GROUP,
            ...
            FabricItemGroup.builder().icon(() -> new ItemStack(Iteminit.CHOCOLATE_CAKE))
                    ...
                    .entries((displayContext, entries) -> {
                        ...
                        entries.add(BlockInit.COCONUT_LEAVES);
                        entries.add(BlockInit.COCONUT_LOG);
                        entries.add(BlockInit.COCONUT_WOOD);
                        entries.add(BlockInit.STRIPPED_COCONUT_LOG);
                        entries.add(BlockInit.STRIPPED_COCONUT_WOOD);
                        entries.add(BlockInit.COCONUT_PLANKS);
                        entries.add(BlockInit.COCONUT_STAIRS);
                        entries.add(BlockInit.COCONUT_SLAB);
                        entries.add(BlockInit.COCONUT_FENCE);
                        entries.add(BlockInit.COCONUT_FENCE_GATE);
                        entries.add(BlockInit.COCONUT_DOOR);
                        entries.add(BlockInit.COCONUT_TRAPDOOR);
                        entries.add(BlockInit.COCONUT_PRESSURE_PLATE);
                        entries.add(BlockInit.COCONUT_BUTTON);
                        entries.add(BlockInit.COCONUT_SIGN);
                        entries.add(BlockInit.COCONUT_HANGING_SIGN);
                        entries.add(Iteminit.COCONUT_BOAT);
                        entries.add(Iteminit.COCONUT_CHEST_BOAT);
                        ...
                        entries.add(Iteminit.MANGO_PIE);
                        ...
                        entries.add(Iteminit.MANGO_DONUT);
                        ...
                        entries.add(Iteminit.MANGO_ICE_CREAM);
                        ...
                        entries.add(Iteminit.MANGO_BUBBLEGUM);
                        ...
                        entries.add(Iteminit.FRUIT_SKEWER);
